    ...
    <nav className={`${isDarkBg ? 'nav-yellow-bg':'nav-blue-bg'} `}>
      <Link href="/" id="home" legacyBehavior>
        <a className="navbar_container_logo">
          <img src= {`${isDarkBg ? 'https://port2bucket.s3.amazonaws.com/yellow-jo-logo.svg'  :'https://port2bucket.s3.amazonaws.com/jo_logo.svg'}`} className='logo-div'

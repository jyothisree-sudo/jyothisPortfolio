        ...
        <div  className={`${isDarkBg ? 'yellow-bg' : 'blue-bg'} projects-parent-div`}  id='projects-parent-div' ref={ref}>
            ...
            <div className="p-all-10">
                ...
                <div className="margin-top-10">
                    ...
                    <li className="m-all-10 text-underline pointer f-d-r al-center">
                        <a target="_blank" href='https://www.zivame.com/survey/questions' className="f-italic">Visit my survey page by click</a>
                        <FaHandPointer style={{'height':'2.5rem', 'width':'2.5rem','margin-right':'1rem'}}/>
                    </li>
                    </ul>
                </div>
            </div>
            ...
            <div className="p-all-10">
                ...
                <div className="margin-top-10">
                    ...
                    <li className="m-all-10 text-underline pointer f-d-r al-center">
                        ...
                        className="f-italic">Visit my view similar widget by click     </a>
                        <FaHandPointer style={{'margin-left':'0rem'}}/>
            ...
            <div className="p-all-10">
                ...
                <div className="margin-top-10">
                    ...
                    <li className="m-all-10 text-underline pointer f-d-r al-center">
                        <a target="_blank" href='https://www.zivame.com/seller.html' className="f-italic">Visit my seller form by click   </a>
                        <FaHandPointer style={{'margin-left':'0rem'}}/>
                    </li>
                    </ul>
                </div>

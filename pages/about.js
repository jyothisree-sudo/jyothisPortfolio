      ...
      <div className="f-d-r about-internal-div">
        <div className="f-d-c al-center justify-center mobile-about-div">
          <div className="my-profile-icon m-all-10 profile-bg">
            <Image src='https://port2bucket.s3.amazonaws.com/girl-work.gif' alt="Girl working" height={200} width={150} />
          </div>
          <div className="">
        ...
        <div className="f-d-c">
          <div className="f-d-r al-center justify-sb desktop-about-div">
            ...
            <div className="my-profile-icon m-all-10 profile-bg">
              <Image src='https://port2bucket.s3.amazonaws.com/girl-work.gif' alt="Girl working" height={300} width={250} />
            </div>
          </div>
          <div>
